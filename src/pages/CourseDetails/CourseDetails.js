    ...
    return (
        <div className='container'>
         ...
         <h1 className='m-0 py-2'>Welcome to {name} course</h1>
          ...
          <div className='col-md-3 col-12 justify-content-center justify-content-md-end d-flex'>
  ...
  <div className="row g-0">
    ...
    <div className="col-md-7">
      <div ref={ref} className="card-body py-4 px-5">
       ...
       <h3 className='me-4 duration'>{duration} months</h3>
       <h3 className='price'>{price} TK</h3>
       </div>
